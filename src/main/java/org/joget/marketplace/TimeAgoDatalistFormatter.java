...
public class TimeAgoDatalistFormatter extends DataListColumnFormatDefault {
        ...
        private String getClientSideTimeAgoScript() {
                ...
                script.append(
                                "      result += diffYears + ' ' + i18n.year.trim() + ' ' + remainingMonths + ' ' + i18n.month.trim() + ' ' + remainingDays + ' ' + i18n.day.trim();\n");
                script.append("    } else if (diffMonths > 0) {\n");
                script.append("      result += diffMonths + ' ' + i18n.month.trim() + ' ' + remainingDays + ' ' + i18n.day.trim();\n");
